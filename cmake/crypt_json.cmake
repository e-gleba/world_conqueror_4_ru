...
#         -DDIR=<assets/data> -P crypt_json.cmake
#
# Encrypt always writes MD5_SIZE (md5 + origsize + ct). Decrypt
# auto-detects the header. Silent on success: per-file output is
# captured and printed only on failure (fatal). Two summary lines
