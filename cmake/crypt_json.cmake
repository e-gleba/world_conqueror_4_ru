...
# crypt_json.cmake — encrypt/decrypt every *.json in DIR, in place.
#
#   cmake -DPYTHON3=<python> -DWCRYPT=<wc4_crypt.py> -DMODE=encrypt|decrypt
#         -DDIR=<dir> [-DHEADER=<fmt>] -P crypt_json.cmake
#
