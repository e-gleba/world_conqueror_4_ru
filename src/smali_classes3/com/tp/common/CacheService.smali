...
# static fields
.field private static a:Lcom/tp/common/DiskLruCache;
...
.method public static getFromDiskCache(Ljava/lang/String;)[B
    ...
    :try_start_1
    invoke-virtual {p0, v0}, Lcom/tp/common/DiskLruCache$Snapshot;->getInputStream(I)Ljava/io/InputStream;

    move-result-object v2

    if-eqz v2, :cond_3

    invoke-virtual {p0, v0}, Lcom/tp/common/DiskLruCache$Snapshot;->getLength(I)J
    ...
    :try_start_2
    invoke-static {v0, v1}, Lcom/tp/adx/sdk/util/Streams;->readStream(Ljava/io/InputStream;[B)V
    :try_end_2
    ...
    invoke-virtual {v1}, Lcom/tp/common/DiskLruCache$Snapshot;->close()V
...
.method public static getFromDiskCacheAsync(Ljava/lang/String;Lcom/tp/common/CacheService$DiskLruCacheGetListener;)V
    ...
    invoke-virtual {v0, p0}, Lcom/tp/common/CacheService$a;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
...
.method public static putToDiskCacheAsync(Ljava/lang/String;[B)V
    ...
    invoke-virtual {v0, p0}, Lcom/tp/common/CacheService$b;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
